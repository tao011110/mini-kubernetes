...
func DeleteFuncPodInstance(cli *clientv3.Client, podInstanceID string, num int) (bool, def.Service) {
	flag := true
	podInstanceKey := podInstanceID
	fmt.Println("podInstanceKey:  ", podInstanceKey)
	...
	fmt.Println("get  ", podInstance.Metadata.Name)
